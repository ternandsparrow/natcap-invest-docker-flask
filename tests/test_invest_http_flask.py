...
class Test(unittest.TestCase):
    ...
    def test_pollination01(self):
        ...
        with open(os.path.join(static_files_dir_path, 'example-reveg-vector.json')) as f:
            reveg_data = f.read()
        data = '{"crop_type":"apple","years":3,"farm":%s,"reveg":%s}' % (farm_data, reveg_data)
        result = self.init_test_app(StubModelRunner()).post('/pollination', data=data,
    ...
    def test_pollination02(self):
        ...
        result = self.init_test_app().post('/pollination', data=data,
